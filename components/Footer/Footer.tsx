                ...
                <div className={`${styles.footerContent} parent`}>
                    <div className={`${styles.fc40} ${styles.fcFlex} ${styles.fcWs}`}>
                        ...
                        <ul className={styles.socialLinks}>
                            <li>
                                <a className={styles.fbIcon} href="https://www.facebook.com/LaSalleHandball/" rel="noopener noreferrer" target="_blank" aria-label='facebook' style={{display: 'block', width: '25px', height: '25px'}}>
                            ...
                            <li>
                                <a className={styles.instaIcon} href="https://www.instagram.com/lasallehandball/?hl=en" rel="noopener noreferrer" target="_blank" aria-label='instagram' style={{display: 'block', width: '25px', height: '25px'}}>
                            ...
                            <li>
                                <a className={styles.tiktokIcon} href="http://www.tiktok.com/@lasallehandball" rel="noopener noreferrer" target="_blank" aria-label='tiktok' style={{display: 'block', width: '25px', height: '25px'}}>
